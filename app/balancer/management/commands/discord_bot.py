...
class Command(BaseCommand):
    ...
    async def rename_myself_command(self, msg, **kwargs):
        ...
        valid_name_pattern = (
            r'^[\w\-\|\\/\s]*'  # Allows alphanumeric, hyphen, underscore, pipe, backslash, forward slash, and spaces
            r'('
            ...
            r')*[\w\-\|\\/\s]*$'  # Ending with any amount of alphanumeric and allowed symbols
        )

        if not re.fullmatch(valid_name_pattern, new_name) or len(new_name) > max_length:
